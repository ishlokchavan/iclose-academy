...
export function PartnerVerifyOtpForm({ email, next }: { email: string; next?: string }) {
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2 text-center sm:text-left">
        ...
        <h1 className="text-[28px] font-bold tracking-tight text-ink">Enter your 6-digit code</h1>
